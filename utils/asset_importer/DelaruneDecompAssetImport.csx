...
var projectFilePath = Path.GetFullPath(Path.Combine(Directory.GetCurrentDirectory(), "..", "..", "DELTARUNE.yyp"));

if (File.Exists(projectFilePath))
    decompPath = projectFilePath;

if (decompPath == null)
    decompPath = PromptLoadFile("DELTARUNE.yyp", "Deltarune Decomp|DELTARUNE.yyp");
